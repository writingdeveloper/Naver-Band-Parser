...
//             userDataDir: 'C:\\Users\\SIHYEONGLEE\\AppData\\Local\\Google\\Chrome\\User Data',
//             headless: false
//         }); // default is true
...
(async () => {
    ...
    let postNumber = 4272;  // 시작되는 PostNumber * 이 부분 부터 시작 *
    while (postNumber <= 5000) {    // PostNumber 끝값 * 이 부분은 마지막 값 *
        await page.goto(`https://band.us/band/58075840/post/${postNumber}`, {
